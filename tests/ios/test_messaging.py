...
def test_survey_navigates_correctly(
    ...
    start_app()
    xcodebuild.test(
        "XCUITests/ExperimentIntegrationTests/testMessageNavigatesCorrectly",
        build=False,
        erase=False,
    )
...
def test_survey_no_thanks_navigates_correctly(
    ...
    start_app()
    xcodebuild.test(
        "XCUITests/ExperimentIntegrationTests/testMessageNoThanksNavigatesCorrectly",
        build=False,
        erase=False,
    )
    # assert check_ping_for_experiment(reason="enrollment", branch=experiment_branch)
...
def test_survey_landscape_looks_correct(
    ...
    start_app()
    xcodebuild.test(
        "XCUITests/ExperimentIntegrationTests/testMessageLandscapeUILooksCorrect",
        build=False,
        erase=False,
    )
    # assert check_ping_for_experiment(reason="enrollment", branch=experiment_branch)
...
def test_homescreen_survey_navigates_correctly(
    ...
    start_app()
    xcodebuild.test(
        "XCUITests/ExperimentIntegrationTests/testHomeScreenMessageNavigatesCorrectly",
        build=False,
        erase=False,
    )
    # assert check_ping_for_experiment(reason="enrollment", branch=experiment_branch)
...
def test_homescreen_survey_dismisses_correctly(
    ...
    start_app()
    xcodebuild.test(
        "XCUITests/ExperimentIntegrationTests/testHomeScreenMessageDismissesCorrectly",
        build=False,
        erase=False,
    )
    # assert check_ping_for_experiment(reason="enrollment", branch=experiment_branch)
