...
@scenario("../features/user_interface.feature", "The experiment does not drastically slow down Firefox")
...
@scenario("../features/user_interface.feature", "The experiment should not block Firefox updates")
